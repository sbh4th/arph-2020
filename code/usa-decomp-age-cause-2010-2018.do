...
tempname nhisp
import delimited "data/us-age-cause-nhisp-2010-2018.txt", ///
...
// load the mortality data, downloaded from CDC WONDER database
tempname hisp
import delimited "data/us-age-cause-hisp-2010-2018.txt", ///
  encoding(ISO-8859-1) clear
...
save "data/usa-decomp-age-cause-2010-2018.dta", replace
...
use "data/usa-decomp-age-cause-2010-2018.dta", clear
...
export delimited using ///
  "data/le-age-decomp-2010-2018.csv", nolabel replace
...
* save this as a dataset for plotting in R
export delimited using ///
  "data/le-age-cause-decomp-2010-2018.csv", nolabel replace
