...
list1 <- list(list("B_1", "Gender"),
               list("B_2", "Race"),
               list("B_3", "Year"),
               list("B_4", "D76.V17"))
data1 <- getData(TRUE, "Detailed Mortality", list1)


list1 <- list(list("Group Results By", "D76.V4"),
              list("And By", "Gender"))

data1 <- getData(TRUE, "Detailed Mortality", list1)

# Cancer trends
mylist <- list(list("Group Results By", "Gender"),
               list("And By", "Race"),
               list("D76.V4", "GR113-019"))
data2 <- getData(TRUE, "Detailed Mortality", mylist)

mylist3 <- list(list("Group Results By", "Gender"),
                list("And By", "Race"),
                list("And By", "D76.V1"))
data3 <- getData(TRUE, "Detailed Mortality", mylist3)

we <- list(list("B_1", "D76.V1-level1"),
           list("B_2", "D76.V8"),
           list("B_3", "D76.V7"),
           list("D76.V5", "1"))
wed <- getData(TRUE, "Detailed Mortality", we)

# By age
age <- list(list("B_1", "D76.V5"))
aged <- getData(TRUE, "Detailed Mortality", age)              
