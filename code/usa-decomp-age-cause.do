...
tempname nhisp
import delimited "data/us-age-cause-nhisp.txt", ///
...
// load the mortality data, downloaded from CDC WONDER database
tempname hisp
import delimited "data/us-age-cause-hisp.txt", ///
  encoding(ISO-8859-1) clear
...
save "data/usa-decomp-age-cause.dta", replace


// #2
// calculate some age-adjusted death rates
* bring in 2000 US standard million population
...
merge 1:m age using "data/usa-decomp-age-cause.dta"
drop _merge
...
use "data/usa-decomp-age-cause.dta", clear
...
* save this as a dataset for plotting in R
export delimited using ///
  "data/le-age-cause-decomp.csv", nolabel replace
